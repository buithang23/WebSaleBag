...
<link rel="stylesheet" type="text/css" href="<c:url value='./resources/styles/single_styles.css'/>">
</head>
<body>
		...
		<div class="row">
					...
					<div class="row">
						<div class="col-lg-3 thumbnails_col order-lg-1 order-2">
							<div class="single_product_thumbnails">
								<ul>
									<li><img src="./resources/images/${product.getImg()}" alt="" "></li>
									<li class="active"><img src="./resources/images/${product.getImg()}" alt="""></li>
									<li><img src="./resources/images/${product.getImg()}" alt="""></li>
								</ul>
							</div>
						</div>
						<div class="col-lg-9 image_col order-lg-2 order-1">
							<div class="single_product_image">
								<div class="single_product_image_background" style="background-image:url(./resources/images/${product.getImg()}"></div>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="col-lg-5">
				<div class="product_details">
					...
					<div class="product_price" id ="giasp" data-sp = "${product.getPrice()}">${product.getPrice()}</div>
					...
					<div class="quantity d-flex flex-column flex-sm-row align-items-sm-center">
						...
						<div class="red_button add_to_cart_button"><a style="color: White" id="cart" onclick="cartfunction('${product.getProductid()}','${product.getProductname()}','${product.getPrice()}','${product.getImg()}')">add to cart</a></div>
